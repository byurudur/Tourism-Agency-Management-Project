...
public class RoomEditView extends Layout {
    ...
    private void saveOrUpdateHotel() {
        ...
        if (Helper.isFieldListEmpty(new JTextField[]{fld_room_number, fld_stock, fld_capacity, fld_square_meters, fld_beds_count, fld_child_price, fld_adult_price})) {
            Helper.getMessage("Not Null", "Error");// Section 24-25 : The user is given appropriate pop up messages for successful transactions. Appropriate error messages are given to the user for incorrect operations.
        } else {
    ...
    private void updateRoom() { // Section 13-14 : Agency staff can add rooms to hotels registered in the system. The prices of the newly added rooms are determined according to the season, hostel type and whether the guests are adults or children.
        ...
        Helper.getMessage("Update", "Information");// Section 24-25 : The user is given appropriate pop up messages for successful transactions. Appropriate error messages are given to the user for incorrect operations.
        btn_back.setText("Back");
    }

    // Method to save room details
    private void saveRoom() { // Section 13-14 : Agency staff can add rooms to hotels registered in the system. The prices of the newly added rooms are determined according to the season, hostel type and whether the guests are adults or children.
        // Get selected hotel ID from combo box
        ComboItem items = (ComboItem) cmb_hotel_name.getSelectedItem();
        room.setRoom_hotel_id(items.getKey());
        ...
        if (cmb_pansion_type.getSelectedItem() == null || cmb_seasson.getSelectedItem() == null) {
            ...
            Helper.getMessage("Pansion or Season type is empty, please check hotel edit page", "Information");// Section 24-25 : The user is given appropriate pop up messages for successful transactions. Appropriate error messages are given to the user for incorrect operations.
            ...
            // Show confirmation message
            Helper.getMessage("Saved", "Information");// Section 24-25 : The user is given appropriate pop up messages for successful transactions. Appropriate error messages are given to the user for incorrect operations.
            btn_back.setText("Back");
        }
    }
}
