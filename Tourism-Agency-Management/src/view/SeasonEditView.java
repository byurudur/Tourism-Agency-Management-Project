...
public class SeasonEditView extends Layout {
    ...
    public SeasonEditView(Season season) {
        ...
        add(container);
        // Set page attributes
        pageArt(640, 480, "Season Edit View");// Section 24-25 : The user is given appropriate pop up messages for successful transactions. Appropriate error messages are given to the user for incorrect operations.
        setTheme("Nimbus");
