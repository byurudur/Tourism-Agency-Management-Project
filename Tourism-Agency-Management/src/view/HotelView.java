        ...
        btn_edit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (tbl_hotel.getSelectedRow() < 0) { //If it does not select a value from the table
                    Helper.getMessage("Please select a Hotel", "Error");// Section 24-25 : The user is given appropriate pop up messages for successful transactions. Appropriate error messages are given to the user for incorrect operations.
                } else {
